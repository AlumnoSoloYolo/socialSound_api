    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_perfil', models.ImageField(blank=True, default='fotos_perfil/default_profile.png', upload_to='fotos_perfil/')),
                ('fecha_nac', models.DateField(null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now)),
                ('rol', models.PositiveIntegerField(choices=[(1, 'cliente'), (2, 'moderador')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artista_favorito', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='detalle_album', to='socialSound.album')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_especialidad', models.CharField(blank=True, max_length=100, null=True)),
                ('codigo_moderador', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='moderador', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Playlist',
